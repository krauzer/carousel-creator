...
if Sinatra::Application.development?
  ...
  Refile.store ||= Refile::Backend::FileSystem.new(APP_ROOT.join("spec", "tmp", "uploads", "store"))
  Refile.cache ||= Refile::Backend::FileSystem.new(APP_ROOT.join("spec", "tmp", "uploads", "cache"))
else
