...
module.exports = function(grunt) {
  ...
  var app = {
    ...
    layoutSrc: "app/templates/",
    viewsSrc: "app/templates/",
    viewsDist: "dist/templates/"
  };
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      styles: {
        files: { '<%= app.stylesTemp %>application.css' : ['<%= app.stylesSrc %>normalize.css','<%= app.stylesSrc %>basscss.css','<%= app.stylesSrc %>basscssextend.css','<%= app.stylesSrc %>*.css']  }
       }
     },
